...
namespace Model.Services.UnitTests
{
    ...
    //        var activateService = new BlockActivateService(validation);
    //        var destroyService = new BlockDestroyService(game, validation, setBlockService, activateService);
    ...
    //        var random = new BlockTypeFactory(game, destroyService, configProvider, moveService, validation);
    //        var changeTypeService = new BlockChangeTypeService(game, validation);

    //        var service = new BlockSpawnService(game, blockFactory, random, validation, changeTypeService, setBlockService);
