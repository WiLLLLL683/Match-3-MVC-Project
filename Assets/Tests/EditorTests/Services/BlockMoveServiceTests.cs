...
namespace Model.Services.UnitTests
{
    public class BlockMoveServiceTests
    {
        ...
        public void Move_BlockToBlock_BlocksSwapped()
        {
            ...
            var blockA = TestUtils.CreateBlockInCell(TestUtils.RED_BLOCK, gameBoard.Cells[0, 0]);
            var blockB = TestUtils.CreateBlockInCell(TestUtils.RED_BLOCK, gameBoard.Cells[1, 0]);
