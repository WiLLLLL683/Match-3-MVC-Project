...
{
    [System.Serializable]
    [CreateAssetMenu(fileName = "NewBoosterSet", menuName = "Config/BoosterSet")]
    public class BoosterSetSO : ScriptableObject
    {
        ...
        [Button] public void FindAllBlockTypesInProject() => assetFinder.FindAllAssetsOfType(ref boosters, this);
#endif
    }
}