...
public class GameBoardInput : MonoBehaviour
{
    ...
    public event Action<Block> OnTouchBegan;
    public event Action<Block, Vector2> OnSwipeMoving;
    public event Action<Block, Directions> OnSwipeEnded;
    public event Action<Block> OnTap;
